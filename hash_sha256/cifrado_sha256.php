...
$dicCifrado = hash("sha256",$direccion);
$idenCifrado = hash("sha256",$identificacion);
$paswCifrado = hash("sha256",$contrasena);
...
if ($conexionDB) 
{
    ...
    VALUES('".$nombre."','".$apaterno."','".$amaterno."','".$dicCifrado."','".$correo."','".$telefono."','".$idenCifrado."','".$paswCifrado."','SHA256');";
    $resultado = mysqli_query($conexionDB, $query);
    if ($resultado) {
        echo '<script>
        location.href = "./hash_sha256.php";
