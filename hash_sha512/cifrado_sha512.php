...
$dicCifrado = hash("sha512",$direccion);
$idenCifrado = hash("sha512",$identificacion);
$paswCifrado = hash("sha512",$contrasena);
...
if ($conexionDB) 
{
    ...
    VALUES('".$nombre."','".$apaterno."','".$amaterno."','".$dicCifrado."','".$correo."','".$telefono."','".$idenCifrado."','".$paswCifrado."','SHA512');";
    $resultado = mysqli_query($conexionDB, $query);
    if ($resultado) {
        echo '<script>
        location.href = "./hash_sha512.php";
