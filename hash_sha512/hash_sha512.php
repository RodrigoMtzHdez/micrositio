            ...
            <div id="my-nav" class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="dropdown-item" href="./hash_sha512.php">SHA512</a>
                        </div>
                    </li>
                    <li class="nav-item active">
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <div class="row">
                    <br>                   
                    <div class="col-lg-12">
                        <center><h3 class="card-title">Cifrado con HASH - SHA512</h3></center>
                        <br>
                        <div class="card">
                            <div class="card-header bg-primary">Formulario de Usuarios</div>
                            <div class="card-body">
                                <p class="card-text">
                                    <form method="post" action="./cifrado_sha512.php">
                                        <div class="form-row">
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <?php                                       
                                        ...
                                        if ($conexionDB) {
                                            ...
                                            FROM tblusuarios WHERE tblusuarios.vchTipoCifrado = 'SHA512';";
