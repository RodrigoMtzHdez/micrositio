...
function descifrar($msjCifrado, $key_privada)
{
    openssl_private_decrypt(base64_decode($msjCifrado), $datos_descifrados, $key_privada);
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            ...
            <div id="my-nav" class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./asimetrico.php">Encriptación Asimétrico RSA</a>
                    </li>
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <div class="row">
                    <br>
                    <div class="col-lg-12">
                        <center><h3 class="card-title">Cifrado Asimétrico RSA</h3></center>
                        <br>
                        <div class="card">
                            <div class="card-header bg-primary">Formulario de Usuarios</div>
                            <div class="card-body">
                                <p class="card-text">
                                    <form method="post" action="./cifrado_rsa.php">
                                        <div class="form-row">
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <?php                                       
                                        ...
                                        if ($conexionDB) {
                                            ...
                                            FROM tblusuarios WHERE tblusuarios.vchTipoCifrado = 'Asimetrico';";
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <?php
                                        if (isset($_POST['consultar'])) 
                                        {
                                            ...
                                            $conexionDB = $conn->conectarDB();
                                            if ($conexionDB) {
                                                $sql = "SELECT tblusuarios.idUsuario, tblusuarios.vchNombre, tblusuarios.vchApaterno, tblusuarios.vchAmaterno, tblusuarios.txtDireccion, tblusuarios.vchCorreo, tblusuarios.vchTelefono, tblusuarios.txtIdentificacion, tblusuarios.txtPassword, tblusuarios.txtPrivada 
                                                FROM tblusuarios WHERE tblusuarios.idUsuario = ".$idusuario.";";
                                                $result = mysqli_query($conexionDB, $sql);

                                                while ($mostrar = mysqli_fetch_array($result)) {
                                                    $dicDescifrado = descifrar($mostrar['txtDireccion'],$mostrar['txtPrivada']);
                                                    $idenDescifrado = descifrar($mostrar['txtIdentificacion'],$mostrar['txtPrivada']);
                                                    $paswDescifrado = descifrar($mostrar['txtPassword'],$mostrar['txtPrivada']);                                                                                 
                                    ?>
